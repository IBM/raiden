...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { target_rx }]; #IO_L16N_T2_A15_D31_14 		Sch=ck_io[27]
set_property PULLDOWN TRUE [get_ports target_rx]
